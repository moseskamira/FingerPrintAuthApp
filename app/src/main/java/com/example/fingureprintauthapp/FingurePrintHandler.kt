...
class FingerPrintHandler(val context: Context) : FingerprintManagerCompat.AuthenticationCallback() {

    private val cancellationSignal = android.support.v4.os.CancellationSignal()
